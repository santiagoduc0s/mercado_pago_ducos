...
/// Response wrapper for retrieving a payment preference.
///
...
class GetPreferenceResponseBody implements ResponseBody {
  ...
  /// This is the same as the Cust ID.
  ...
  ///
  /// Includes details such as name, email, phone, identification,
  /// address, and registration date.
  final Payer payer;

  /// Return URLs to the seller's site.
  ///
  /// Used for auto-return after payment or via a 'Return to site' button.
  ...
  ///
  /// Recommended only for integration testing.
  final String sandboxInitPoint;

  /// Valid JSON containing additional attributes to be added to the payment.
  final Map<String, dynamic> metadata;

  /// Creates an instance of [GetPreferenceResponseBody] with all required fields.
  ...
  /// Creates a [GetPreferenceResponseBody] from a JSON map.
  ///
