...
class UpdatePreferenceResponseBody implements ResponseBody {
  ...
  ///
  /// Includes details such as name, email, phone, personal identification,
  /// address, and registration date.
  final Payer payer;

  /// Return URLs to the seller's site.
  ///
  /// These URLs are used for auto-return after payment or via a 'Return to site' button.
  ...
  ///
  /// Example: "036151801-2484cd71-7140-4c51-985a-d4cfcf133baf".
  final String id;
  ...
  /// Creates an instance of [UpdatePreferenceResponseBody] with all required fields.
  UpdatePreferenceResponseBody({
  ...
  /// Creates an instance of [UpdatePreferenceResponseBody] from a JSON map.
  ///
  ...
  factory UpdatePreferenceResponseBody.fromJson(Map<String, dynamic> json) {
    return UpdatePreferenceResponseBody(
      collectorId: json['collector_id'],
      operationType: json['operation_type'],
      // Convert the JSON list to a list of Item instances.
