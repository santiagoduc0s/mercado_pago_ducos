...
class CreatePreferenceResponseBody implements ResponseBody {
  ...
  ///
  /// Includes name, email, phone, personal identification, address, and registration date.
  final Payer payer;
  ...
  ///
  /// Only valid if a marketplace is defined.
  ...
  factory CreatePreferenceResponseBody.fromJson(Map<String, dynamic> json) {
    return CreatePreferenceResponseBody(
      ...
      // Parse each item in the list into an Item instance.
